(ns
  ^{:author mate.magyari}
  mini-projects.swarm.main
  (:require [clojure.test :as test]
            [mini-projects.swarm.swarm :as swarm]
            [mini-projects.swarm.the-wild :as w]
            [mini-projects.swarm.display :as display]
            [mini-projects.swarm.view-adapter :as v]
...
;;(typed/check-ns 'mini-projects.swarm.vector-algebra)
